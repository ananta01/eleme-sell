<template>
  <transition name="move">
    <div v-show="showFlag" class="food" ref="elFood">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <rating-select :select-type="selectType" :only-content="onlyContent"
                 :desc="desc" :ratings="food.ratings" v-on:ratingtype-select="changeSelectType"
                 v-on:ratingcontent-select="changeContent"></rating-select>
